...
bool Adafruit_LSM9DS1::begin()
{
  ...
  */
  ...
  //reg 6 odr 119
  write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG6_XL, 0x60); // 1 KHz out data rate, BW set by ODR, 408Hz anti-aliasing
  write8(XGTYPE, LSM9DS1_REGISTER_CTRL_REG7_XL, 0xE0); //High resolution and 10 Hz lowpass cutoff, try it out
